...
public class RedAutoTop extends OpMode {
    ...
    private final Pose startPose = new Pose(122.84364060676779, 122.15635939323221, Math.toRadians(50));
    private final Pose shootPose = new Pose(96.55192532088682, 95.77596266044341, Math.toRadians(50));

    private final Pose beginPickup1 = new Pose(96.55192532088682, 83.84597432905484, Math.toRadians(0));
    private final Pose finalPickup1 = new Pose(131, 83.84597432905484, Math.toRadians(0));

    private final Pose beginPickup2 = new Pose(96.55192532088682, 60, Math.toRadians(0));
    private final Pose finalPickup2 = new Pose(141, 60, Math.toRadians(0));
    private final Pose midCurveFPickupShoot = new Pose(98.7317073171, 36.8780487804878);
    private final Pose leave = new Pose(91.3170731707, 126.82926829268293, Math.toRadians(0));
